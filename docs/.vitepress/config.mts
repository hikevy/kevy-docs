...
const baseConfig = isEdgeOne ? '/' : '/kevy-docs/'
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'PDF版本下载', link: 'https://github.com/hikevy/kevy-docs/releases' },
    ],
    search: {
      provider: 'local',
      options: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/hikevy/kevy-docs' }
    ],

    editLink: {
      pattern: 'https://github.com/hikevy/kevy-docs/blob/main/docs/:path'
    },
